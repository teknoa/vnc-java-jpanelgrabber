...
public class RRE extends SimpleRectangle
{
	...
	public RRE( int[] pixels, int offsetX, int offsetY, int scanline, int x, int y, int w, int h )
	{
		super( x, y, w, h );
	...
	public RRE( int x, int y, int w, int h, int bgpixel, SubRect[] subrects )
	{
		super( x, y, w, h );
	...
	public void writeData( DataOutput output ) throws IOException
	{
		...
		for( int i = 0; i < subrects.length; i++ )
		{
			...
			output.writeInt(subrects[i].pixel);
//			writePixel( output, subrects[i].pixel );
		}
	}
	...
	public Object clone() throws CloneNotSupportedException
	{
		...
		return new RRE( x, y, w, h, bgpixel, subrectsClone );
	}
}
